# Task 7: Create map-reviewer-prompt.md

**Files:**
- Create: `skills/codebase-cleanup/map-reviewer-prompt.md`

**Context:** `context/skill-conventions.md`

This prompt is dispatched at the end of Step 2 (after the REDUCE phase). It reviews the full code map for accuracy and completeness before Step 3 analysis begins. If issues are found, the consolidator fixes them and the reviewer re-reviews.

---

- [ ] **Step 1: Create the prompt template**

Create `skills/codebase-cleanup/map-reviewer-prompt.md` with this exact content:
...
**1. Missing symbols**
Spot-check 3–5 source files from the confirmed scope. Open each file and verify its exported symbols appear in the corresponding directory map. Report any obvious omissions.
...
- Are there groups with only one directory that could reasonably be merged with another group?
...
Expected: `map-reviewer-prompt.md` appears in the listing
